(ns codewars.rainfall-test
  (:require [clojure.test :refer :all]
            [codewars.rainfall :refer :all]))
...
(deftest a-test1
  (testing "Rainfall mean with data"
    (assertFuzzyEquals (mean "London", data), 51.199999999999996)
    (assertFuzzyEquals (mean "Beijing", data), 52.416666666666664)
)) 
(deftest a-test2
  (testing "Rainfall mean with data1"
    (assertFuzzyEquals (mean "London", data1), 57.03333333333333)
    (assertFuzzyEquals (mean "Beijing", data1), 59.083333333333336)))
